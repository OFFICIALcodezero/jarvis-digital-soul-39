      ...
      <div className="weather-widget-compact bg-black/40 p-3 rounded-lg border border-[#33c3f0]/20">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="ml-2">
              <div className="text-lg font-bold text-white">{data.current.temp}°F</div>
  ...
  return (
    <div className="weather-widget bg-black/40 p-4 rounded-lg border border-[#33c3f0]/20">
      ...
      <div className="flex items-center mb-4">
        {getWeatherIcon(data.current.condition)}
        <div className="ml-3">
          <div className="text-2xl font-bold">{data.current.temp}°F</div>
          <div className="text-sm text-gray-300">{data.current.condition}</div>
        </div>
        <div className="ml-auto">
          <div className="text-xs text-gray-400">Humidity: {data.current.humidity}%</div>
          <div className="text-xs text-gray-400">Wind: {data.current.windSpeed} mph</div>
        </div>
      </div>
